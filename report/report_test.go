...
func TestRunFullAnalysis_OnEachShippedFixture(t *testing.T) {
	for _, name := range []string{"minimal.json", "qbp_quantum_v0_1.json", "qbp_quantum_v0_2.json", "qbp_dm_fork.json", "qbp_v3_2.json", "predictions_lifecycle.json", "predictions_lifecycle_v0_3.json"} {
